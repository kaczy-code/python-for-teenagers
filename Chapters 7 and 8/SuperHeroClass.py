...
superPowers = [
    'Flying', 'Super Strength', 'Telepathy', 'Super Speed',
...
superFirstName = [
    'Wonder', 'Whatta', 'Rabid', 'Incredible', 'Astonishing', 'Decent',
    'Stupendous', 'Above-average', 'That Guy', 'Improbably'
]

superLastName = [
    'Boy', 'Man', 'Dingo', 'Beefcake', 'Girl', 'Woman', 'Guy', 'Hero', 'Max',
    'Dream', 'Macho Man', 'Stallion'
]
...
if answer2 == '1':
    ...
    print(
        "You did not choose the proper answer! Program will now self-destruct!"
    )
